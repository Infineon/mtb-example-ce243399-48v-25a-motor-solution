...
# configurations.
TARGET=KIT_PSC3M5_MTR_48V_25A

# Name of application (used to derive name of final linked file).
#
# If APPNAME is edited, ensure to update or regenerate launch
# configurations for your IDE.
APPNAME=mtb-example-ce243399-48v-25a-motor-solution
...
ifeq ($(TOOLCHAIN),IAR)
CFLAGS+=--diag_suppress=Pe177       # Suppress: static inline function declared but never referenced
endif
